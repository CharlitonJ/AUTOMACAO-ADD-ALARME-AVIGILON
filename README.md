...
Entrada de Dados: O usuário define o nome da unidade e o número total de câmeras a serem configuradas.

Reconhecimento de Imagem: O script utiliza capturas de tela para localizar botões, campos de busca e ícones de ativação.

Padronização: Gera nomes automáticos seguindo o modelo "Unidade - CAM XX" e insere nos campos de alarme.

Tratamento de Exceções: Caso um elemento visual não seja encontrado, o script interrompe o processo e informa ao usuário em qual ciclo ocorreu a falha.
...
Documentação de automação para sistemas de segurança.
